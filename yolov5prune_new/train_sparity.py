...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default=ROOT / 'runs/finetune/exp19/weights/best.pt', help='initial weights path')
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp18/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=[640, 360], help='train, val image size (pixels)')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train_sparity', help='save to project/name')
